...
var MembersListComponent = (function () {
    function MembersListComponent(router, memberListService, countriesService, membershipTypesService, groupsService, popupComponent) {
        var _this = this;
        this.router = router;
        ...
        this.editMember = function () {
            ...
            if (OrganisationMemberID === -1) {
                ...
                _this.memberComponent.loadMember(OrganisationMemberID, _this.countries, _this.MembershipTypes, _this.Groups);
            }
        };
        /////////////////////////////////////////////////////////////
        //grid
    ...
    MembersListComponent = __decorate([
        core_1.Component({
            ...
            providers: [member_list_serv_1.MemberListService, countries_serv_1.CountriesService, membership_type_serv_1.MembershipTypesService, groups_serv_1.GroupsService, popup_comp_1.PopupComponent],
            directives: [main_1.AgGridNg2, member_comp_1.MemberComponent, popup_comp_1.PopupComponent]
        }), 
        __metadata('design:paramtypes', [router_deprecated_1.Router, member_list_serv_1.MemberListService, countries_serv_1.CountriesService, membership_type_serv_1.MembershipTypesService, groups_serv_1.GroupsService, popup_comp_1.PopupComponent])
