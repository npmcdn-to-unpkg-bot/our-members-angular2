...
var MembersListComponent = (function () {
    function MembersListComponent(router, memberListService, countriesService, membershipTypesService) {
        var _this = this;
        this.router = router;
        ...
        this.onRowDoubleClicked = function (params) {
            ...
            _this.memberComponent.loadMember(selectedMember.OrganisationMemberID, _this.countries, _this.MembershipTypes);
    ...
    MembersListComponent = __decorate([
        core_1.Component({
            ...
            providers: [member_list_serv_1.MemberListService, countries_serv_1.CountriesService, membership_type_serv_1.MembershipTypesService],
            directives: [main_1.AgGridNg2, member_comp_1.MemberComponent]
        }), 
        __metadata('design:paramtypes', [router_deprecated_1.Router, member_list_serv_1.MemberListService, countries_serv_1.CountriesService, membership_type_serv_1.MembershipTypesService])
