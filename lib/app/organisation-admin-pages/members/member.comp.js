...
var MemberComponent = (function () {
    function MemberComponent(router, memberService, modal, viewContainer) {
        var _this = this;
        this.router = router;
    ...
    MemberComponent.prototype.showModalMessage = function () {
    ...
    MemberComponent = __decorate([
        ...
        __metadata('design:paramtypes', [router_deprecated_1.Router, member_serv_1.MemberService, bootstrap_1.Modal, core_1.ViewContainerRef])
    ], MemberComponent);
