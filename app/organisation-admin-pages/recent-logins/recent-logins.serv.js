...
var RecentLoginsService = (function () {
    function RecentLoginsService(http, router) {
        this.http = http;
        this.router = router;
...
exports.RecentLoginsService = RecentLoginsService;
//# sourceMappingURL=recent-logins.serv.js.map