System.register(['@angular/core', '@angular/router-deprecated', './login.serv', '@angular/http'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_deprecated_1, login_serv_1, http_1;
    var LoginComponent;
    return {
        setters:[
            function (core_1_1) {
